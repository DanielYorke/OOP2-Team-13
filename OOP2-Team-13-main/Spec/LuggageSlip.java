...
public class LuggageSlip{
    ...
    public String toString(){
        ...
        output = String.format("%s PP NO. %s NAME: %c.%s NUMLUGGAGE: %d CLASS: %c",this.luggageSlipID ,owner.getPassportNumber(), owner.getFirstName().charAt(0), owner.getLastName(), owner.getNumLuggage(), owner.getCabinClass());
        if(! label.equals("")){
            output += " $105";
        }
        return output;
